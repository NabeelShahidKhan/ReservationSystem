<%@ Page Title="Valima" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Valima.aspx.cs" Inherits="ObrsBanquet.Valima" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <!-- Page Heading -->
        <div class="row">
            <h1 class="my-4 col-lg-6">Reservation  <small>Valima Plan</small></h1>
        ...
        <div class="row text-center">
            <asp:Label ID="InfoLable" CssClass="text-info h5 align-content-center" runat="server" Text="Select Any Stage,Entrance and Sitting Style.."></asp:Label>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <asp:Image ID="Image10" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/Classy-Wedding-Door-Entrance-Decorators-in-Pondicherry.jpg" Width="350px" Height="200px" />
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <asp:Image ID="Image7" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/mehndi-entrance-decorations-www.ideas_.bestwedding-dresses-1.jpg" Width="350px" Height="200px" />
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <asp:Image ID="Image15" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/26907012_1990072227917814_3597041185302863541_n.jpg" Width="350px" Height="200px" />
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <asp:Image ID="Image5" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/images (1).jpg" Width="350px" Height="200px" />
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <asp:Image ID="Image6" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/27332230_1990072507917786_4270215605459397005_n.jpg" Width="350px" Height="200px" />
                    <br />
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <asp:Image ID="Image17" runat="server" CssClass="card-img-top" ImageUrl="~/floor%20plan/a/images (9).jpg" Width="350px" Height="200px" />
